...
| `frame_target_found` | Primera **fijación** (no una mirada de paso) cuya **masa de mirada** sobre la casilla objetivo alcanza el umbral (0,34; consciente del error del aparato, no un voto duro de centroides): cuándo se ve el objetivo. La fijación se detecta por dispersión (criterio I-DT). |
